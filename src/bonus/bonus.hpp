...
public:
  ...
  Bonus(Vector2 position, BonusType t) : pos(position), type(t) {}

  void update(float dt) { pos.y += fallSpeed * dt; }
  ...
  void onCollected() { collected = true; }

  bool isDestroyed() const override { return collected; }
